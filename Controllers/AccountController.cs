...
namespace Blog.Controllers
{
    ...
    public class AccountController : ControllerBase
    {
            ...
            [FromServices] BlogDataContext context, [FromServices] EmailService email)
        {
            ...
            {
                StatusCode(500, new ResultViewModel<string>("05X04 - Falha interna no servidor"));
            }
        ...
        public async Task<IActionResult> Login([FromBody] LoginViewModel model,
            [FromServices] BlogDataContext context, [FromServices] TokenService tokenService)
        {
           ...
           var user = await context
            ...
            {
                return StatusCode(500, new ResultViewModel<string>("05x04 - Falha interna no serivodor"));
            }
        }
            ...
            [FromServices] BlogDataContext context)
        {
            ...
            user.Image = $"https://localhost:44361/images/{fileName}";
